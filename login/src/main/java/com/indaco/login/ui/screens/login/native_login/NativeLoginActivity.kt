...
class NativeLoginActivity : BaseActivity<ActivityNativeLoginBinding>() {
    ...
    private fun isEmailEntryValid(email: String?): Boolean {
        val error =  when {
            email.isNullOrBlank() -> getString(com.indaco.daggertestapp.R.string.error_email_blank)
            email.isEmailInvalid() -> getString(com.indaco.daggertestapp.R.string.error_email_not_email_pattern)
            else ->  null
        }
    ...
    private fun isPasswordValid(password: String?): Boolean {
        val error =  when {
            password.isNullOrBlank() -> getString(com.indaco.daggertestapp.R.string.error_password_blank)
            password.length < MIN -> getString(com.indaco.daggertestapp.R.string.error_password_short)
            password.length > MAX -> getString(com.indaco.daggertestapp.R.string.error_password_long)
            password.any { !it.isLetterOrDigit() } -> getString(com.indaco.daggertestapp.R.string.error_password_not_alphanumeric)
            else ->  null
        }
    ...
    private fun showError() {
        AlertDialog.Builder(this)
            .setTitle(getString(com.indaco.daggertestapp.R.string.error_title))
            .setMessage(getString(com.indaco.daggertestapp.R.string.user_not_found))
            .setPositiveButton(getString(com.indaco.daggertestapp.R.string.ok), null)
            .show()
    }
